  ...
  return (
    <div>
      ...
      <CalenderRow
        ...
        margin="mt-[2.5%]"
        BackroundColour={"bg-red-600"}
        TextColour={"text-white"}
      />

      <CalenderRow
        DaysOfWeek={generateDays(0)}
        margin=""
        BackroundColour={"bg-white"}
        TextColour={"text-black"}
      />
      <CalenderRow
        DaysOfWeek={generateDays(1)}
        margin=""
        BackroundColour={"bg-white"}
        TextColour={"text-black"}
      />
      <CalenderRow
        DaysOfWeek={generateDays(2)}
        margin=""
        BackroundColour={"bg-white"}
        TextColour={"text-black"}
      />
      <CalenderRow
        DaysOfWeek={generateDays(3)}
        margin=""
        BackroundColour={"bg-white"}
        TextColour={"text-black"}
      />
      <CalenderRow
        DaysOfWeek={generateDays(4)}
        margin="mb-[2.5%]"
        BackroundColour={"bg-white"}
        TextColour={"text-black"}
      />
